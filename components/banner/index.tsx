        ...
        <div className="py-4 lg:py-20 mx-4 lg:mx-0">
            <div className="container mx-auto">
                <div className="flex flex-col">
                    ...
                    <Link href={"https://github.com/Asam237/top-mangas/issues/new?assignees=&labels=&template=take-the-manga.yaml&title=DO+NOT+EDIT+-+takes+the+manga"}>
                    <button className={`bg-white flex items-center justify-center sm:w-1/3 mx-auto mt-6 lg:mt-10 rounded-lg font-bold px-6 py-4 text-black ${poppins.className}`}><span><BiBot size={25} className="mr-4" /></span>Add a manga</button>
                    </Link>
                </div>
            </div>
        </div>
